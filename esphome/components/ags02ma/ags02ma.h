...
class AGS02MAComponent : public PollingComponent, public i2c::I2CDevice {
 public:
  ...
  /**
   * Modifies target address of AGS02MA.
   *
 ...
 protected:
  ...
  /**
   *  Reads and returns a firmware version of AGS02MA.
   */
  optional<uint8_t> read_version_();

  /**
   * Reads and returns the resistance of AGS02MA.
   */
...
template<typename... Ts> class AGS02MANewI2cAddressAction : public Action<Ts...>, public Parented<AGS02MAComponent> {
 public:
...
enum AGS02MASetZeroPointActionMode {
  // Zero-point reset.
  FACTORY_DEFAULT,
...
template<typename... Ts> class AGS02MASetZeroPointAction : public Action<Ts...>, public Parented<AGS02MAComponent> {
 public:
  TEMPLATABLE_VALUE(uint16_t, value)
  TEMPLATABLE_VALUE(AGS02MASetZeroPointActionMode, mode)
